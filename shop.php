...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="inner-page-hero bg-image" data-image-src="images/img/logo1.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                        <div class="bg-gray restaurant-entry">
                            <div class="row">
                                <?php $ress= mysqli_query($db,"select * from shop");
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="products.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="logo"></a>
															</div>
															<!-- end:Logo -->
