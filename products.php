...
<head>
    ...
    <link rel="icon" href="#">
    <title>Products || Online Stationery System</title>
    ...
    <div class="page-wrapper">
        ...
        <?php $ress= mysqli_query($db,"select * from shop where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/office_kit2.png">
            <div class="profile">
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action='products.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/products/'.$product['img'].'" alt="Product logo">'; ?></a>
                                            </div>
